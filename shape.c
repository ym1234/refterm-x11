// build: gcc shape.c -lm -lcairo -lfontconfig -lharfbuzz  -lfreetype -I/usr/include/freetype2 -I/usr/include/fontconfig/ -I/usr/include/harfbuzz/ -I/usr/include/cairo/
#include <stdlib.h>
#include <stdio.h>
#include <math.h>
