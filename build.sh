...
if $(gcc -Wall -lm -O0 -g main.c -o term -lstdc++ /home/ym/fun/tracy/library/unix/obj/release/o/public/TracyClient.o -lGLU -lGL -lX11 -lfreetype -Ibuild/include/ ./build/src/glad.c -I/usr/include/freetype2); then
