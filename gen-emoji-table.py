...
# You can view the terms of the license here: https://www.gnu.org/licenses/old-licenses/gpl-2.0.html
...
print(" */")
print()
print("#ifndef EMOJI_TABLE_H")
print("#define EMOJI_TABLE_H")
print()
...
for typ,s in ranges.items():
	...
	print()
	print("static const struct Interval %s_table[] =" % typ)
	print("{")
