...
#line 1 "NONE"
	{ts = p;}
	break;
#line 143 "emoji_presentation_scanner.c"
		}
	}
	...
	if ( _klen > 0 ) {
		...
		while (1) {
			...
			if ( EmojiSegmentationCategory(*p) < *_mid )
				_upper = _mid - 1;
			else if ( EmojiSegmentationCategory(*p) > *_mid )
				_lower = _mid + 1;
			else {
	...
	if ( _klen > 0 ) {
		...
		while (1) {
			...
			if ( EmojiSegmentationCategory(*p) < _mid[0] )
				_upper = _mid - 2;
			else if ( EmojiSegmentationCategory(*p) > _mid[1] )
				_lower = _mid + 2;
			else {
...
#line 1 "NONE"
	...
	break;
#line 257 "emoji_presentation_scanner.c"
		}
	}
...
#line 1 "NONE"
	{ts = 0;}
	break;
#line 270 "emoji_presentation_scanner.c"
		}
	}
